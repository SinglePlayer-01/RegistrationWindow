...
// Coordinats for text
D2D1_RECT_F rect_text_login = D2D1::RectF(286.5, 16, 350.5, 42);
D2D1_RECT_F rect_text_Password = D2D1::RectF(265.5, 115, 372.5, 143);
D2D1_RECT_F rect_text_RepeatPassword = D2D1::RectF(228.5, 214, 418.5, 242);
D2D1_RECT_F rect_text_Registration = D2D1::RectF(68, 263, 206, 274);
D2D1_RECT_F rect_text_Help = D2D1::RectF(451, 244, 300, 290);

// Coordinats for Round Rect
D2D1_RECT_F rect_EnterField_Login = D2D1::RectF(158.5, 50, 463.5, 95);
D2D1_RECT_F rect_EnterField_Password = D2D1::RectF(158.5, 152, 463.5, 197);
D2D1_RECT_F rect_EnterField_RepeatPassword = D2D1::RectF(158.5, 254, 463.5, 299);
D2D1_ROUNDED_RECT enterField_Login = D2D1::RoundedRect(rect_EnterField_Login, 30, 30);
D2D1_ROUNDED_RECT enterField_Password = D2D1::RoundedRect(rect_EnterField_Password, 30, 30);
D2D1_ROUNDED_RECT enterField_RepeatPassword = D2D1::RoundedRect(rect_EnterField_RepeatPassword, 30, 30);